        ...
        <div className="overflow-x-auto mb-3 max-w-full">
          <table className="min-w-[1200px] border text-sm text-center table-fixed">
            <thead className="bg-gray-100 text-xs font-bold">
              <tr>
                <th className="w-64 p-0.5 font-bold text-slate-700 border" rowSpan={2}>الحساب</th>
                <th className="w-40 p-0.5 font-bold text-slate-700 border" colSpan={2}>نقدي</th>
                <th className="w-40 p-0.5 font-bold text-slate-700 border" colSpan={2}>ذهب</th>
                <th className="w-20 p-0.5 font-bold text-slate-700 border" rowSpan={2}>المعايرة</th>
                <th className="w-20 p-0.5 font-bold text-slate-700 border" rowSpan={2}>الضريبة</th>
                <th className="w-20 p-0.5 font-bold text-slate-700 border" rowSpan={2}>نسبة الضريبة</th>
                <th className="w-20 p-0.5 font-bold text-slate-700 border" rowSpan={2}>الرقم الضريبي</th>
                {costCenters.length > 0 && (
                  <th className="w-40 p-0.5 font-bold text-slate-700 border" rowSpan={2}>مركز التكلفة</th>
                )}
                <th className="w-48 p-0.5 font-bold text-slate-700 border" rowSpan={2}>البيان</th>
                <th className="w-12 p-0.5 font-bold text-slate-700 border" rowSpan={2}>حذف</th>
              </tr>
              <tr>
                <th className="w-20 p-0.5 font-bold text-slate-700 border">مدين</th>
                <th className="w-20 p-0.5 font-bold text-slate-700 border">دائن</th>
                <th className="w-20 p-0.5 font-bold text-slate-700 border">مدين</th>
                <th className="w-20 p-0.5 font-bold text-slate-700 border">دائن</th>
              </tr>
            </thead>
                ...
                <tr key={index} className="border-b border-slate-100 hover:bg-slate-50">
                  <td className="p-0.5 border">
                    <AsyncCreatableSelect
                      ...
                      onChange={(selectedOption) => {
                        ...
                        const selected = opt?.account || accounts.find((acc) => acc.id === opt?.value);
                        ...
                        onUpdateDetail(index, "acc_code", selected.acc_code ?? selected.code ?? "");
                        onUpdateDetail(index, "acc_name", selected.acc_name ?? selected.name ?? "");
                  ...
                  <td className="p-0.5 border">
                    <input
                      ...
                      onChange={(e) => onUpdateDetail(index, "debit", parseFloat(e.target.value) || 0)}
                      type="number"
                      step="0.01"
                  ...
                  <td className="p-0.5 border">
                    <input
                      ...
                      onChange={(e) => onUpdateDetail(index, "credit", parseFloat(e.target.value) || 0)}
                      type="number"
                      step="0.01"
                      className="border w-full p-0.5 text-xs text-center appearance-none"
                      placeholder="0.00"
                  ...
                  <td className="p-1 border">
                    <input
                      ...
                      onChange={(e) => onUpdateDetail(index, "debit_g", parseFloat(e.target.value) || 0)}
                      type="number"
                      step="0.01"
                  ...
                  <td className="p-0.5 border">
                    <input
                      ...
                      onChange={(e) => onUpdateDetail(index, "credit_g", parseFloat(e.target.value) || 0)}
                      type="number"
                      step="0.01"
                      className="border w-full p-0.5 text-xs text-center appearance-none"
                      placeholder="0.00"
                  ...
                  <td className="p-0.5 border">
                    <input
                      ...
                      onChange={(e) => onUpdateDetail(index, "gauge", parseInt(e.target.value) || 875)}
                      type="number"
                      className="border w-full p-0.5 text-xs text-center appearance-none"
                      placeholder="875"
                    />
                  ...
                  <td className="p-0.5 border">
                    <input
                      ...
                      onChange={(e) => onUpdateDetail(index, "tax", parseFloat(e.target.value) || 0)}
                      type="number"
                      step="0.01"
                      className="border w-full p-0.5 text-xs text-center appearance-none"
                      placeholder="0.00"
                  ...
                  <td className="p-0.5 border">
                    <input
                      ...
                      onChange={(e) => onUpdateDetail(index, "tax_prc", parseFloat(e.target.value) || 0)}
                      type="number"
                      step="0.01"
                      className="border w-full p-0.5 text-xs text-center appearance-none"
                      placeholder="0.00"
                  ...
                  <td className="p-1 border">
                    <input
                      ...
                      onChange={(e) => onUpdateDetail(index, "vat_no", parseInt(e.target.value) || 0)}
                      type="number"
                      className="border w-full p-1 text-xs text-center appearance-none"
                      placeholder="0"
                    />
                  ...
                  {costCenters.length > 0 && (
                    <td className="p-1 border">
                      <select
                        ...
                        onChange={(e) => onUpdateDetail(index, "cost_id", e.target.value ? parseInt(e.target.value) : null)}
                  ...
                  <td className="p-1 border">
                    <input
                      ...
                      onChange={(e) => onUpdateDetail(index, "vouch_notes", e.target.value)}
                      type="text"
                      className="border w-full p-1 text-xs text-center appearance-none"
                      placeholder="البيان"
                    />
