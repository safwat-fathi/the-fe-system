        ...
        <ModalContent>
          <ModalHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold">صلاحيات المستخدم: {user.username}</h3>
              </div>
            </div>
          </ModalHeader>
          <ModalBody>
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="5xl" scrollBehavior="inside">
      <ModalContent>
        ...
        <ModalBody>
          <Alert color="info" variant="flat" className="mb-4">
            هذه الصلاحيات خاصة بالمستخدم وتتجاوز صلاحيات المجموعات التي ينتمي إليها
          </Alert>
