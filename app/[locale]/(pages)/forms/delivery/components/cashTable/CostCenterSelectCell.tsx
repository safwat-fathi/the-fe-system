...
type CostCenterSelectCellProps = {
  ...
  options: Option[];
  value: Option | null;
  onChange: (index: number, selectedOption: Option | null) => void;
  onKeyDown: (
    e: KeyboardEvent,
    index: number,
    colIndex: number,
...
const CostCenterSelectCell = ({
  ...
  return (
    <div
      id={`cash-cost-center-wrapper-${index}`}
      ref={handleRef}
      className="h-full"
    >
      <ReactSelect
        ...
        instanceId={`cash-cost-center-select-${index}`}
