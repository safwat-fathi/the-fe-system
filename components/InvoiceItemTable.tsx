...
export default function InvoiceItemTable({
  ...
  const handleFieldChange = (
    ...
    if (field === "g_weight") {
      ...
      if (homePurity && weightVal > 0) {
        ...
        const wCalc =
          weightVal < 1 && gWeightVal > weightVal
            ? weightVal * 1000
            : weightVal;
  ...
  const handleTotalAChange = (index: number, value: any) => {
    ...
    if (updated[index]) {
      ...
      updated[index].total =
        (updated[index].total_a || 0) + (updated[index].total_w || 0);
              ...
              <tr key={item.id}>
                <td>
                  <AsyncCreatableSelect
                    ...
                    onChange={(selectedOption) => {
                      ...
                      if (
                        !updated[index].purity ||
                        updated[index].purity === "0" ||
                        updated[index].purity === ""
                      ) {
                ...
                <td>
                  <input
                    ...
                    type="number"
                    value={parseFloat(
                      item.weight?.toFixed(weightDigits) || "0",
                    )}
                    onChange={(e) =>
                ...
                <td>
                  <input
                    ...
                    type="number"
                    value={parseFloat(
                      item.g_weight?.toFixed(gWeightDigits) || "0",
                    )}
                    onChange={(e) =>
                ...
                {(payType === 1 || payType === 3) && (
                  <td>
                    <input
                      ...
                      type="number"
                      value={parseFloat(
                        item.price?.toFixed(priceDigits) || "0",
                      )}
                      onChange={(e) =>
                ...
                {(payType === 2 || payType === 3) && (
                  <td>
                    <input
                      ...
                      type="number"
                      value={parseFloat(
                        item.price_w?.toFixed(priceWDigits) || "0",
                      )}
                      onChange={(e) =>
                ...
                {(payType === 1 || payType === 3) && (
                  <td>
                    <input
                      ...
                      type="number"
                      value={parseFloat(
                        (item.weight * item.price).toFixed(totalADigits),
                      )}
                      onChange={(e) =>
                ...
                {(payType === 2 || payType === 3) && (
                  <td>
                    <input
                      ...
                      type="number"
                      value={parseFloat(
                        (item.weight * (item.price_w || 0)).toFixed(
                          totalWDigits,
                        ),
                      )}
                      onChange={(e) =>
                ...
                <td>
                  <input
                    ...
                    type="number"
                    value={parseFloat(
                      item.item_disc_amt?.toFixed(itemDiscDigits) || "0",
                    )}
                    onChange={(e) =>
