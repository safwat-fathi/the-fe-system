...
const getCashReceiptFormData = cache(async (): Promise<CashReceiptFormData> => {
...
const getCashReceiptVoucherForNavigation = cache(async () => {
  try {
...
const getCashReceiptVoucher = cache(
...
const getCashReceiptDetails = cache(
  async (
    voucherId: number,
...
const getCashReceiptBoxes = cache(
  async (
    voucherId: number,
    branchId?: number | string,
